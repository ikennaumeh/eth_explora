...
class App extends Component {
  ...
  //function that'll connect to the blockchain
  // and load the data from it
  async componentWillMount(){
    //Load web3
    let web3 = new Web3('https://mainnet.infura.io/v3/ea73ef8b5701496cbbdb4031df57bcdd')
    ...
    for(let i = 0; i < 10; i++){
      ...
      console.log('lastest blocks', block)
          ...
          <div className="row">
            <main role="main" className="col-lg-12 d-flex text-center">
              <div className="content mr-auto ml-auto" style={{width: '800px'}}>
                <h5> Ethereum Blockchain Explora</h5>
                <div className='row'>
                  <div className='col-4'>
